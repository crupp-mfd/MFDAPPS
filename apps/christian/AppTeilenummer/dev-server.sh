...
export PYTHONPATH="$ROOT_DIR:$ROOT_DIR/packages/sparepart-shared/src:$ROOT_DIR/apps/christian/AppTeilenummer/src:${PYTHONPATH:-}"
...
export MFDAPPS_FRONTEND_DIR="$ROOT_DIR/apps/christian/AppTeilenummer/frontend"
...
exec uvicorn app_teilenummer.main:app --reload "$@"
